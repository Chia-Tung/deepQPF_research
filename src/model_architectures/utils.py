...
def get_encoder_params_GRU(input_channel_count, input_shape):
    print(
        f"[EncoderParams] InputChannelCount: {input_channel_count}, Shape: {input_shape}"
    )
    msg = (
        "Input gets downsampled by a factor of 5, 3 and 2 sequentially"
    ...
    forecaster_params_GRU = [
        ...
        [
            BasicGRU(
                input_channel=128,
                num_filter=128,
                h_w=(16, 16),  # For forecaster, this variable is never used.
                zoneout=0.0,
                L=13,
                i2h_kernel=(3, 3),
                i2h_stride=(1, 1),
            ...
            BasicGRU(
                input_channel=128,
                num_filter=128,
                h_w=(32, 32),  # For forecaster, this variable is never used.
                zoneout=0.0,
                L=13,
                i2h_kernel=(3, 3),
                i2h_stride=(1, 1),
            ...
            BasicGRU(
                input_channel=32,
                num_filter=32,
                h_w=(96, 96),  # For forecaster, this variable is never used.
                zoneout=0.0,
                L=9,
                i2h_kernel=(3, 3),
                i2h_stride=(1, 1),
