...
from models.forecaster import Forecaster, Forecaster_PONI, Forecaster_addPONI
    ...
    if model_type == ModelType.BaselineCNN:
        ...
        if model_type in [
            ...
            if model_type in [ModelType.BalancedGRUAdvPONI, ModelType.BalancedGRUAdvPONIAtten,]:
                forecaster = Forecaster_PONI(forecaster_params_GRU[0],forecaster_params_GRU[1], data_kwargs['target_len'],
